"""Shared pytest fixtures for AgricultureClaw unit tests."""
import os
import sys
...
import pytest
from agri_helpers import init_all_tables, get_conn, build_env


@pytest.fixture
def db_path(tmp_path):
    """Per-test fresh SQLite database with foundation + agricultureclaw schema."""
...
@pytest.fixture
def env(conn):
    """Full agriculture environment: company, naming series, accounts, FY, CC."""
